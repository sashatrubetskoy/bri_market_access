...
python3 code/analysis/run_all_projects.py
echo "Done running all projects."

echo "Creating top project for cities table..."
python3 code/tables_and_figures/table_top_project_for_cities.py
echo "Top project for cities table created."

echo "Creating top projects table..."
python3 code/tables_and_figures/table_top_projects.py
